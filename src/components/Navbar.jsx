        ...
        <nav key={isLoggedIn} className="bg-gray-900 shadow-md">
            <div className="flex items-center justify-between p-4">
                ...
                <div className="hidden sm:flex space-x-4 items-center">
                    <NavLink to="/" className="text-gray-300 hover:text-blue-400 px-3 py-2 text-md font-medium">
                        Home
                    </NavLink>
                    <NavLink to="/about" className="text-gray-300 hover:text-blue-400 px-3 py-2 text-md font-medium">
                        About
                    </NavLink>
                    ...
                    {isLoggedIn ? (
                        ...
                        <>
                            ...
                            <NavLink to="/login" className="text-gray-300 hover:text-blue-400 px-3 py-2 text-md font-medium">
                                Log In
                            </NavLink>
                        </>
                    )}
            ...
            {isOpen && (
                <div className="sm:hidden bg-gray-800 text-white flex flex-col space-y-4 py-4 px-6">
                    <NavLink to="/" className="text-gray-300 hover:text-blue-400 py-2 text-md font-medium" onClick={() => setIsOpen(false)}>
                        Home
                    </NavLink>
                    <NavLink to="/about" className="text-gray-300 hover:text-blue-400 py-2 text-md font-medium" onClick={() => setIsOpen(false)}>
                        About
                    </NavLink>
                    ...
                    {isLoggedIn ? (
                        ...
                        <>
                            ...
                            <NavLink to="/login" className="text-gray-300 hover:text-blue-400 py-2 text-md font-medium" onClick={() => setIsOpen(false)}>
                                Log In
                            </NavLink>
                        </>
                    )}
